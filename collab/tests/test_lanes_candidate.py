...
class TestBudgetCharging:
    def test_breaker_and_verifier_calls_charged(self, tmp_path):
        ...
        lanes.run_lane(
            ...
            verifier_seat="v",
            builder_seat="builder",
            runner=_fake("FINDING: x -> boom", "VERDICT: REFUTED"),
            budget=budget,
        )
